                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      menuButton(context, title: "Home Screen", routeName: "/homescreen", icon: Icons.home_rounded, color: const Color.fromARGB(255, 73, 122, 47)),
                      menuButton(context, title: "My Course", routeName: "/mycourse", icon: Icons.bookmark, color: const Color.fromARGB(255, 203, 237, 5)),
                      menuButton(context, title: "My Place", routeName: "/myplace", icon: Icons.landscape, color: const Color.fromARGB(255, 206, 11, 128)),
